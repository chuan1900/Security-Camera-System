...
def add_street(D,street,temp):
    ...
    if D:
        ...
        for k,v in D.iteritems():
            if k==street.group(2):
                add=1
                errSt="Error:'a'specified for a street that already exists \n"
